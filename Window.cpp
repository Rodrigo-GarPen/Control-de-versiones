...
void Window::ManejaTeclado(GLFWwindow* window, int key, int code, int action, int mode)
{
	...
	if (key == GLFW_KEY_K)
	{
		...
		else if (theWindow->articulacion5 <= -50.0f) {
			theWindow->articulacion5 = -50.0f;
			paso = 5.0f;
		}
	}
	if (key == GLFW_KEY_L)
	{
		...
		if (theWindow->articulacion6 >= 0.0f) {
			theWindow->articulacion6 = 0.0f;
			paso = -5.0f;
		}
		else if (theWindow->articulacion6 <= -50.0f) {
			theWindow->articulacion6 = -50.0f;
			paso = 5.0f;
		}
	}
