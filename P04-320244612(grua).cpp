...
int main()
{
	...
	*/
	...
	glm::mat4 modelauxaux(1.0);//Inicializar matriz de Modelo 4x4
	...
	//rotación alrededor de la articulación que une con la cabina
		...
		//Canasta
		model = glm::translate(model, glm::vec3(0.5f, 0.1f, 0.0));
		...
		// BASE
		modelaux = modelauxaux;
		model = modelaux;
		model = glm::translate(model, glm::vec3(0.0f, -2.0f, 0.0));
		modelaux = model;
		modelauxaux = model;
		model = glm::scale(model, glm::vec3(7.0f, 3.0f, 3.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		...
		//Articulación5 llanta
		model = modelaux;
		model = glm::translate(model, glm::vec3(-3.0f, -1.5f, 1.8f));
		...
		//Llanta izquierda (se ve de frente)
		//model = glm::translate(model, glm::vec3(-3.0f, -1.5f, 1.8f));
		...
		//Llanta derecha (se ve de frente)
		model = glm::scale(model, glm::vec3(3.0f, 3.0f, 1.5f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		...
		//Llanta izquierda (se ve por atrás)
		model = glm::scale(model, glm::vec3(3.0f, 3.0f, 1.5f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		...
		//Llanta derecha (se ve por atrás)
		model = glm::scale(model, glm::vec3(3.0f, 3.0f, 1.5f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
